          ...
          <SidebarGroup>
            ...
            <SidebarMenu>
              <SidebarMenuButton as-child tooltip="Dashboard" class="hover:bg-muted">
                <NuxtLink to="/management/auditor/">
            ...
            <SidebarMenu>
              <SidebarMenuButton as-child tooltip="Evaluation" class="hover:bg-muted">
                <NuxtLink to="/management/auditor/evaluation">
